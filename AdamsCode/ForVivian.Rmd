...
```{r}
games = na.omit(read_csv('../Datasets/Final_Data.csv')[-1])
...
KnownHomeAwayStats = games[c(52,1,2,4:7,17:29)]
KnownLeftRightStats = games[c(52,4,29,32,33,40:51)]
```
# Define MAE Function
...
MAE for summing together is 9.666
